...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder2b74d = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer175af = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties9fdc4 = [
        
    ];

    public function getConnection()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'getConnection', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'getMetadataFactory', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'getExpressionBuilder', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'beginTransaction', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'getCache', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->getCache();
    }

    public function transactional($func)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'transactional', array('func' => $func), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->transactional($func);
    }

    public function commit()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'commit', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->commit();
    }

    public function rollback()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'rollback', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'getClassMetadata', array('className' => $className), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'createQuery', array('dql' => $dql), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'createNamedQuery', array('name' => $name), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'createQueryBuilder', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'flush', array('entity' => $entity), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'clear', array('entityName' => $entityName), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->clear($entityName);
    }

    public function close()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'close', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->close();
    }

    public function persist($entity)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'persist', array('entity' => $entity), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'remove', array('entity' => $entity), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'refresh', array('entity' => $entity), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'detach', array('entity' => $entity), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'merge', array('entity' => $entity), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'getRepository', array('entityName' => $entityName), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'contains', array('entity' => $entity), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'getEventManager', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'getConfiguration', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'isOpen', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'getUnitOfWork', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'getProxyFactory', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'initializeObject', array('obj' => $obj), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'getFilters', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'isFiltersStateClean', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'hasFilters', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return $this->valueHolder2b74d->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer175af = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder2b74d) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder2b74d = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder2b74d->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, '__get', ['name' => $name], $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        if (isset(self::$publicProperties9fdc4[$name])) {
            return $this->valueHolder2b74d->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder2b74d;
    ...
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;
    ...
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, '__isset', array('name' => $name), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;
    ...
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, '__unset', array('name' => $name), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;
    ...
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, '__clone', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        $this->valueHolder2b74d = clone $this->valueHolder2b74d;
    }

    public function __sleep()
    {
        $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, '__sleep', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;

        return array('valueHolder2b74d');
    }
    ...
    {
        $this->initializer175af = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer175af;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer175af && ($this->initializer175af->__invoke($valueHolder2b74d, $this, 'initializeProxy', array(), $this->initializer175af) || 1) && $this->valueHolder2b74d = $valueHolder2b74d;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder2b74d;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder2b74d;
    }
